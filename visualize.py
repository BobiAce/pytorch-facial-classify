...
if __name__ == '__main__':
    raw_img = io.imread('images/test_0080.jpg')
    test_img = cv2.imread('images/test_0080.jpg')
    ...
    biaoqing = str(class_names[int(predicted.cpu().numpy())])
    end = time.time()
    print('Test single image spent %s Sec'%(end-start))
    print('Maybe your current emotion is %s'%biaoqing)
